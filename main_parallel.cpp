...
int main() {
    ...
    unsigned char* original_image = stbi_load("img/input60.png", &width, &height, &channels, 0); // Carica tutti i canali
    if (channels == 4) {
    ...
    stbi_write_png("img/output60.png", width, height, channels, original_image, width * 3);
